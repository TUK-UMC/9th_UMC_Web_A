...
const MovieFilter = ({ onChange }: MovieFilterProps) => {
  ...
  return (
    <form
      ...
      className="transform space-y-6 rounded-2xl border border-gray-300 bg-white p-6 transition-all"
    >
      <div className="flex flex-wrap gap-6 items-end">
        ...
        <div className="pt-4">
          <button
            type="submit"
            className="rounded-lg bg-blue-500 px-6 py-2 font-medium text-white transition-all hover:bg-blue-600 hover:shadow-lg"
          >
            영화 검색
          </button>
        </div>
