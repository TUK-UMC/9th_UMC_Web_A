  ...
  return (
    ...
    >
      <div className="relative max-h-[90vh] w-full max-w-3xl overflow-hidden rounded-2xl bg-white shadow-2xl">
        <button
          onClick={onClose}
          className="absolute right-4 top-4 z-10 flex h-10 w-10 items-center justify-center rounded-full bg-gray-800/70 text-white transition-all hover:bg-gray-900 cursor-pointer"
        >
          ...
          <div className="flex flex-1 flex-col">
            ...
            <div className="mt-4 flex justify-center gap-3">
              <button
                ...
                className="rounded-lg bg-blue-600 px-5 py-2 text-sm font-medium text-white transition-all hover:bg-blue-700 hover:shadow-lg cursor-pointer"
              >
                IMDb에서 검색
              </button>
              <button
                onClick={onClose}
                className="rounded-lg border border-gray-300 bg-white px-5 py-2 text-sm font-medium text-gray-700 transition-all hover:bg-gray-50 cursor-pointer"
              >
                닫기
              </button>
            </div>
